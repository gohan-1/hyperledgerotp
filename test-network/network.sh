...
function createOrgs() {
  ...
  if [ "$CRYPTO" == "cfssl" ]; then
    ...
    peer_cert peer peer0.org1.valtrans.com org1
    peer_cert admin Admin@org1.valtrans.com org1

    infoln "Creating Org2 Identities"
    #function_name cert-type   CN   org
    peer_cert peer peer0.org2.valtrans.com org2
    peer_cert admin Admin@org2.valtrans.com org2

    infoln "Creating Orderer Org Identities"
    #function_name cert-type   CN   
    orderer_cert orderer orderer.valtrans.com
    orderer_cert admin Admin@valtrans.com
  ...
  if [ "$CRYPTO" == "Certificate Authorities" ]; then
    ...
    export FABRIC_CA_CLIENT_HOME=${PWD}/organizations/peerOrganizations/org1.valtrans.com/
    COUNTER=0
    rc=1
...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    ${CONTAINER_CLI} volume rm docker_orderer.valtrans.com docker_peer0.org1.valtrans.com docker_peer0.org2.valtrans.com
